...
export default function Post({
    ...
    return <motion.div
        ...
        {...rest}>
        <Link href={`/posts/${slug}`} className={'flex md:flex-row flex-col  gap-1 800px:gap-2 1150px:gap-4'}>

            <Image loading={'lazy'} width={270} height={0} src={featuredImage && featuredImage.sourceUrl}
