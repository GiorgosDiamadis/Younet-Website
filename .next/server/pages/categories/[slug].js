...
/* harmony import */ var lib_posts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3958);
/* harmony import */ var hooks_use_page_metadata__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7322);
/* harmony import */ var lib_categories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7706);
/* harmony import */ var templates_archive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3943);
/* harmony import */ var components_Title__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(886);
...
async function getStaticProps({ params ={}  } = {}) {
    const { category  } = await (0,lib_categories__WEBPACK_IMPORTED_MODULE_3__/* .getCategoryBySlug */ .fj)(params?.slug);
    if (!category) {
        return {
            props: {},
            notFound: true
    ...
    const { posts  } = await (0,lib_posts__WEBPACK_IMPORTED_MODULE_1__/* .getPostsByCategoryId */ .qd)({
...
async function getStaticPaths() {
    ...
    //
    const { categories  } = await (0,lib_categories__WEBPACK_IMPORTED_MODULE_3__/* .getAllCategories */ .tG)();
...
var __webpack_exports__ = __webpack_require__.X(0, [270,676,61,550,251,958,391,706,97,572,943], () => (__webpack_exec__(6178)));
